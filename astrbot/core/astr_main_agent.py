...
async def collect_initial_request(
    ...
    if req is None:
        ...
        # Event-level model override, applied to both the plugin-provided
        # request and the freshly collected one. Direct callers that pass their
        # own request keep full control over the model.

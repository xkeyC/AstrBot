            ...
            "platform": {
                ...
                "config_template": {
                    ...
                    "Mumble": {
                        ...
                        "mumble_host": "",
                        "mumble_port": 64738,
                        "mumble_username": "AstrBot",
                        "mumble_password": "",
                        "mumble_channel": "",
                        "mumble_text_wake_prefix": "!",
                        "mumble_certfile": "",
                        "mumble_keyfile": "",
                        "mumble_reconnect_delay": 5.0,
                        "mumble_voice_enabled": True,
                        "mumble_voice_name": "",
                        "mumble_voice_aliases": [],
                        "mumble_voice_voice": "",
                        "mumble_voice_model": "",
                        "mumble_voice_prompt": "",
                        "mumble_voice_idle_timeout": 300,
                        "mumble_voice_backend": "codex_realtime",
                        "mumble_cascade_url": "ws://127.0.0.1:17890/v1/realtime",
                        "mumble_cascade_token": "",
                        "mumble_cascade_ref_audio": "",
                        "mumble_cascade_tool_filler": "好的，我查一下。",
                        "mumble_cascade_emotion": "calm",
                        "mumble_cascade_emotion_strength": 0.8,
                    },
                    # "WebChat": {
                    #     "id": "webchat",
                    #     "type": "webchat",
                ...
                "items": {
                    ...
                    "mumble_host": {
                        "description": "Mumble 服务器地址",
                        "type": "string",
                        "hint": "Mumble 1.5 及以上的服务器域名或 IP。整个服务器是一个群聊会话，机器人在哪个频道都不影响上下文，可随时拖动。",
                    },
                    "mumble_port": {
                        "description": "Mumble 端口",
                        "type": "int",
                        "hint": "默认 64738。",
                    },
                    "mumble_username": {
                        "description": "机器人用户名",
                        "type": "string",
                        "hint": "机器人在 Mumble 中显示的名字。",
                    },
                    "mumble_password": {
                        "description": "服务器密码",
                        "type": "string",
                        "hint": "服务器设置了密码时填写，或已注册账号的密码。",
                        "secret": True,
                    },
                    "mumble_channel": {
                        "description": "初始频道",
                        "type": "string",
                        "hint": "连接后进入的频道名，或从根频道起的路径（如 游戏/闲聊）。留空则留在服务器默认频道。",
                    },
                    "mumble_text_wake_prefix": {
                        "description": "频道文字唤醒前缀",
                        "type": "string",
                        "hint": "Mumble 没有 @ 功能。频道文字以此前缀开头时唤醒机器人（等同于 @ 机器人）；私聊始终唤醒。发送“前缀+闭麦 / 开麦”可控制语音（也支持 mute / unmute 和全局唤醒前缀）。",
                    },
                    "mumble_certfile": {
                        "description": "客户端证书",
                        "type": "string",
                        "hint": "可选。PEM 证书路径。留空时自动生成并保存在 data/mumble/<平台 ID>/ 下，服务器据此识别机器人，便于管理员注册账号、授予权限。",
                    },
                    "mumble_keyfile": {
                        "description": "客户端证书私钥",
                        "type": "string",
                        "hint": "可选。证书私钥路径；证书文件已包含私钥时留空。",
                    },
                    "mumble_reconnect_delay": {
                        "description": "重连延迟",
                        "type": "float",
                        "hint": "断线后的重连等待时间，单位秒。",
                    },
                    "mumble_voice_enabled": {
                        "description": "启用实时语音",
                        "type": "bool",
                        "hint": "使用 Codex 实时语音（需要 Codex Agent 执行器登录含语音的 ChatGPT 订阅账号）。有人说话时接入，频道语音与私语各自使用独立的语音 Agent 线程，拥有配套会话中普通成员可用的工具与执行环境（按权限规则）。",
                    },
                    "mumble_voice_name": {
                        "description": "语音唤醒名",
                        "type": "string",
                        "hint": "实时语音里机器人的名字，频道里只有叫到它才会回应（由提示词约束，偶尔可能误答）；私语始终回应。留空使用机器人用户名。",
                    },
                    "mumble_voice_aliases": {
                        "description": "语音唤醒别名",
                        "type": "list",
                    ...
                    "mumble_voice_voice": {
                        "condition": {"mumble_voice_backend": "codex_realtime"},
                        "description": "音色",
                        "type": "string",
                        "options": [
                            "",
                    ...
                    "mumble_voice_backend": {
                        "description": "语音后端",
                        "type": "string",
                        "options": ["codex_realtime", "local_cascade"],
                        "labels": ["Codex 实时语音", "本地级联语音"],
                        "hint": "Codex 实时语音：需要 Codex Agent 执行器登录含语音的 ChatGPT 订阅账号。本地级联语音：连接自己部署的 local-multimodal-infra（/v1/realtime），切句、识别、对话和合成都在服务端完成，查询、执行等任务交给配套会话的 Agent（Codex）处理。",
                    },
                    "mumble_cascade_url": {
                        "condition": {"mumble_voice_backend": "local_cascade"},
                        "description": "级联语音服务地址",
                        "type": "string",
                        "hint": "local-multimodal-infra 的实时语音 WebSocket 地址，例如 ws://127.0.0.1:17890/v1/realtime。模型的下载和加载由服务端负责。",
                    },
                    "mumble_cascade_token": {
                        "condition": {"mumble_voice_backend": "local_cascade"},
                        "description": "级联语音服务令牌",
                        "type": "string",
                        "hint": "可选。服务端 LOCAL_MCP_INFER_TOKENS 中的任一令牌；服务端未设置令牌时留空。",
                    },
                    "mumble_cascade_ref_audio": {
                        "condition": {"mumble_voice_backend": "local_cascade"},
                        "description": "参考音频（音色）",
                        "type": "string",
                        "hint": "可选。WAV 文件路径（相对路径按 data 目录解析，不超过 8 MB），机器人用这段声音的音色说话，建议 5～10 秒清晰人声。留空使用服务端的默认音色。",
                    },
                    "mumble_cascade_tool_filler": {
                        "condition": {"mumble_voice_backend": "local_cascade"},
                        "description": "任务应答语",
                        "type": "string",
                        "hint": "可选。把任务交给后台时先说的一句话，例如“好的，我查一下。”留空则不说。",
                    },
                    "mumble_cascade_emotion": {
                        ...
                        "hint": "服务端使用 IndexTTS-2.5 时生效（1.5 会忽略）。沿用参考音频：不指定情绪，语气跟参考音频一样。",
                    },
                    "mumble_cascade_emotion_strength": {
                        "condition": {"mumble_voice_backend": "local_cascade"},
                        "description": "情绪强度",
                        "type": "float",
                        "hint": "0 到 1，默认 0.8；其余部分沿用参考音频的语气。",
                    },
